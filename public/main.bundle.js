...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__modules_app_routing_module__ = __webpack_require__("../../../../../src/app/modules/app-routing.module.ts");
...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
        ...
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_5__modules_app_routing_module__["a" /* AppRoutingModule */],
...
module.exports = "<div class=\"jumbotron text-center\">\n  <h1>Enzyke Jolmenoph</h1>\n  <p class=\"lead\">Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>\n  <div>\n    <a class=\"btn btn-primary\" [routerLink]=\"['/register']\">Register</a> <a class=\"btn btn-primary\" [routerLink]=\"['/login']\">Login</a>\n  </div>\n</div>\n\n<div class=\"row\">\n  <div class=\"col-md-4\">\n    <h3>Express</h3>\n    <p>Taiyaki paleo lomo, hexagon photo booth williamsburg actually cray poke organic freegan squid. </p>\n  </div>\n  <div class=\"col-md-4\">\n    <h3>Angular-CLI</h3>\n    <p>Squid ennui microdosing man bun blog raw denim. </p>\n  </div>\n  <div class=\"col-md-4\">\n    <h3>JWT Tokens</h3>\n    <p>Thundercats ethical humblebrag pinterest gastropub flexitarian, mumblecore whatever 3 wolf moon vaporware aesthetic street art green juice fixie.</p>\n  </div>\n</div>\n"
...
var LoginComponent = (function () {
    function LoginComponent(_flashMessagesService, authService, router) {
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this.authService.authenticateUser(user).subscribe(function (data) {
            if (data.success) {
                ...
                _this._flashMessagesService.show('Welcome ' + data.user.username, {
...
var NavbarComponent = (function () {
    function NavbarComponent(_flashMessagesService, authService, router) {
        this._flashMessagesService = _flashMessagesService;
        this.authService = authService;
        this.router = router;
    }
...
var RegisterComponent = (function () {
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        this.authService.registerUser(user).subscribe(function (data) {
            if (data.success) {
                _this._flashMessagesService.show('Registration successful!', { cssClass: 'alert-success', timeout: 3000 });
                _this.router.navigate(['/login']);
            }
            else {
